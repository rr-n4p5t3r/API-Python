...
class ConsumoServicioSOAP():
    ...
    @classmethod
    def soapRegistrarMensaje(self, subdominio = str, usuario = str, clave = str, asunto = str, texto = str, nombre_destinatario = str, correo_destinatario = str, adjunto = str, nombre_archivo = str, alertas = bool, recordatorio = int, correo_certificado = bool, fecha_vencimiento = datetime):
        try:
    ...
    @classmethod
    def soapObtenerToken(self, dominio_proveedor = str, subdominio = str, usuario = str, clave = str, idMensaje = int, generarPDF = bool):
        try:
            # Datos de autenticación
            url = 'https://'+subdominio+'.'+ dominio_proveedor + '/webService.php?WSDL'
            print(url)
            return True
            username = usuario
            password = clave
    ...
    @classmethod
    def soapCrearIdentidad(self, subdominio = str, usuario = str, clave = str, nombre_identidad = str, email_identidad = str, nombre_grupo = str, tipo_doc_asociado = int, documento_asociado = str, nombre_asociado = str, apellido_asociado = str):
        try:
            # Datos de autenticación
            url = 'https://'+subdominio+'.correocertificado4-72.com.co/webService.php?WSDL'
            username = usuario
